 ...
 * generated in the org.projet.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListeComptes_QNAME = new QName("http://ws.projet.org/", "listeComptes");
    private final static QName _ListeComptesResponse_QNAME = new QName("http://ws.projet.org/", "listeComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.projet.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "listeComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "listeComptesResponse")
